...
<html lang="en">
    <head>
        ...
        <link href="<?php echo get_template_directory_uri(); ?>/frontend/css/bootstrap.min.css" rel="stylesheet">

        <link href="<?php echo get_template_directory_uri(); ?>/frontend/css/bootstrap-icons.css" rel="stylesheet">

        <link href="<?php echo get_template_directory_uri(); ?>/frontend/css/magnific-popup.css" rel="stylesheet">

        <link href="<?php echo get_template_directory_uri(); ?>/frontend/css/templatemo-first-portfolio-style.css" rel="stylesheet">
